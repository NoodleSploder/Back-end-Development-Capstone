...
SONGS_URL = "http://songs-sn-labs-jarednorris1.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song"
...
def songs(request):
    songs = req.get("http://songs-sn-labs-jarednorris1.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song").json()
    return render(request, "songs.html", {"songs": songs["songs"]})


def photos(request):
    photos = req.get("http://songs-sn-labs-jarednorris1.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/song").json()
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if user and user.check_password(password):
                # log in the using the django.contrib.auth module
                login(request, user)
                return HttpResponseRedirect(reverse("index"))
        except User.DoesNotExist:
            # render the `login.html` method using the `LoginForm` form
